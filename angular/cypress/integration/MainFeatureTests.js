...
const extractContent = (element) => element.text().split(' ')[1]
const extractContentAsNumber = (element) => parseInt(element.text().split(' ')[1])
        ...
        cy.get('h4:nth(1)').then(name => {
            ...
            cy.get('h4:nth(2)').then(age => {
                ...
                cy.get('h4:nth(3)').then(city => {
                    ...
                    cy.get('[type=number]').clear().type(oldAge + 100)
                    ...
                    cy.get('h4:nth(1)').then(name => {
                        ...
                        cy.get('h4:nth(2)').then(age => {
                            ...
                            cy.get('h4:nth(3)').then(city => {
                                ...
                                cy.get('[type=number]').clear().type(oldAge)
